...
let night_price = 129;
let week_price = 775;
let mainImg = {src: "/assetts/images/Main-Cabin/002.jpg", alt: "Main cabin living room"};
let link = "./main-cabin";  
...
night_price = 99;
week_price = 600;
mainImg = {src: "/assetts/images/Guest-Cabin/003.jpg", alt: "Guest cabin living room"};
link = "./guest-cabin";  
...
night_price = 200;
week_price = 1200;
mainImg = {src: "/assetts/images/Courtyard/001.jpg", alt: "View of cabins from courtyard area"};
link = "./main-cabin";  
description = "";
amenities = [];
imgs = [];
