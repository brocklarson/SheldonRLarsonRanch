...
let night_price = 129;
let week_price = 775;
let mainImg = {src: "/SheldonRLarsonRanch/assets/images/Main-Cabin/002.jpg", alt: "Main cabin living room"};
let link = "./main-cabin";  
...
let imgs = [
    ...
    {src: "/SheldonRLarsonRanch/assets/images/Courtyard/001.jpg", alt: "View of cabins from courtyard"},
    ...
    {src: "/SheldonRLarsonRanch/assets/images/Main-Cabin/009.jpg", alt: "Main cabin desk area"},
    {src: "/SheldonRLarsonRanch/assets/images/Main-Cabin/011.jpg", alt: "Main cabin heirloom"},
    {src: "/SheldonRLarsonRanch/assets/images/Courtyard/002.jpg", alt: "Back area behind cabins"},
    {src: "/SheldonRLarsonRanch/assets/images/Courtyard/003.jpg", alt: "Backyard behind cabins"},
    ...
    {src: "/SheldonRLarsonRanch/assets/images/Courtyard/006.jpg", alt: "Utah century farm & ranch homestead"},
    {src: "/SheldonRLarsonRanch/assets/images/Ranch/001.jpg", alt: "View of ranch"},
    {src: "/SheldonRLarsonRanch/assets/images/Main-Cabin/010.jpg", alt: "Guest book"},
...
night_price = 99;
week_price = 600;
mainImg = {src: "/SheldonRLarsonRanch/assets/images/Guest-Cabin/003.jpg", alt: "Guest cabin living room"};
link = "./guest-cabin";  
...
imgs = [
    ...
    {src: "/SheldonRLarsonRanch/assets/images/Guest-Cabin/005.jpg", alt: "Guest cabin bedroom"},
    ...
    {src: "/SheldonRLarsonRanch/assets/images/Guest-Cabin/008.jpg", alt: "Guest cabin loft access"},
    ...
    {src: "/SheldonRLarsonRanch/assets/images/Guest-Cabin/012.jpg", alt: "Main cabin heirloom"},
    {src: "/SheldonRLarsonRanch/assets/images/Guest-Cabin/013.jpg", alt: "Guest cabin heirloom"},
    {src: "/SheldonRLarsonRanch/assets/images/Guest-Cabin/014.jpg", alt: "Guest cabin photo wall"},
    {src: "/SheldonRLarsonRanch/assets/images/Courtyard/006.jpg", alt: "Utah century farm & ranch homestead"},
    {src: "/SheldonRLarsonRanch/assets/images/Ranch/001.jpg", alt: "View of ranch"}
];
...
night_price = 200;
week_price = 1200;
mainImg = {src: "/SheldonRLarsonRanch/assets/images/Courtyard/001.jpg", alt: "View of cabins from courtyard area"};
link = "./main-cabin";  
description = "";
amenities = [];
imgs = [];
