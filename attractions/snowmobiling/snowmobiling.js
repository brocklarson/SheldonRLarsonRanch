...
let img = {src: "/assets/images/Activities/004.jpg", alt: "3 snowmobilers overlooking fog above ephraim canyon"}
let shortInfo = ``;
...
img = {src: "/assets/images/Activities/snowmobile-2.jpg", alt: "Man snowmobiling at Joe's Valley in Sanpete, Utah"}
...
img = {src: "/assets/images/Activities/snowmobile-3.jpg", alt: "Man snowmobiling at Miller's Flat in Sanpete, Utah"}
attractionLink = `/assets/downloadables/Skyline_Snowmobile_Map.pdf`;
snowmobiling.addAttraction(title, description, shortInfo, img, attractionLink);
...
img = {src: "/assets/images/Activities/snowmobile-4.jpg", alt: "Man snowmobiling at north skyline drive in Sanpete, Utah"}
attractionLink = `/assets/downloadables/Skyline_Snowmobile_Map.pdf`;
snowmobiling.addAttraction(title, description, shortInfo, img, attractionLink);
...
img = {src: "/assets/images/Activities/snowmobile-5.jpg", alt: "group snowmobiling the scenic mount nebo loop in Sanpete Utah"}
