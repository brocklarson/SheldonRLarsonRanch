...
let img = {src: "/assetts/images/Activities/004.jpg", alt: "3 snowmobilers overlooking fog above ephraim canyon"}
let shortInfo = ``;
let attractionLink = `/assetts/downloadables/Skyline_Snowmobile_Map.pdf`;
...
img = {src: "/assetts/images/Activities/snowmobile-2.jpg", alt: "Man snowmobiling at Joe's Valley in Sanpete, Utah"}
attractionLink = `/assetts/downloadables/Skyline_Snowmobile_Map.pdf`;
snowmobiling.addAttraction(title, description, shortInfo, img, attractionLink);
...
img = {src: "/assetts/images/Activities/snowmobile-3.jpg", alt: "Man snowmobiling at Miller's Flat in Sanpete, Utah"}
attractionLink = `/assetts/downloadables/Skyline_Snowmobile_Map.pdf`;
snowmobiling.addAttraction(title, description, shortInfo, img, attractionLink);
...
img = {src: "/assetts/images/Activities/snowmobile-4.jpg", alt: "Man snowmobiling at north skyline drive in Sanpete, Utah"}
attractionLink = `/assetts/downloadables/Skyline_Snowmobile_Map.pdf`;
snowmobiling.addAttraction(title, description, shortInfo, img, attractionLink);
...
img = {src: "/assetts/images/Activities/snowmobile-5.jpg", alt: "group snowmobiling the scenic mount nebo loop in Sanpete Utah"}
