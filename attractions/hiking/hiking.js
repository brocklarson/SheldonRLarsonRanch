...
import { hiking, Attraction } from "../attractions-class.js";
...
let img = {src: "/assetts/images/Activities/022.jpg", alt: "Milky falls waterfall"}
...
hiking.addAttraction(new Attraction(title, description, shortInfo, img, attractionLink));
...
img = {src: "/assetts/images/Activities/027.jpg", alt: "Maple Canyon Overlook"}
...
img = {src: "/assetts/images/Activities/006.jpg", alt: "Box canyon slot canyon trail"}
...
img = {src: "/assetts/images/Activities/south-tent-mountain_1.png", alt: "South tent mountain summit"}
...
img = {src: "/assetts/images/Activities/023.jpg", alt: "Mount Nebo summit trail"}
